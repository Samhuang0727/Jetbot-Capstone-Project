...
def show_camera():
    ...
    if camera.isOpened():
        ...
        while cv2.getWindowProperty("calibration", 0) >= 0:
            ...
            ##cv2.imwrite('imginitial.jpg',img)
            ...
            while True:
                ...
                if k % 256 == 32:
                    ...
                    # Draw and display the corners
                       ...
                       #use opencv function imwrite to save a photo which is taken by webcam
                ...
                if k % 256 == 99:
                   if n_img <= n_min_img:
                       ...
                       #create ur npz file and save it in your folder
                       np.savez('mycoordinate.npz',ret=ret,mtx=mtx,dist=dist,rvecs=rvecs,tvecs=tvecs)
